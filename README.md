...
Bot bidders favor two working colors, protect their final trump for the last trick, and return non-winning side-color 10s and 5s to the kitty when practical. After a bot is set twice, it must pass for the next three hands.
